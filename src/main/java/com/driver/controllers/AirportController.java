...
public class AirportController {
    ...
    public double getShortestDurationOfPossibleBetweenTwoCities(@RequestParam("fromCity") City fromCity, @RequestParam("toCity")City toCity){
        ...
        double fastestFlight = airportService.getShortestDurationOfPossibleBetweenTwoCities(fromCity, toCity);
    ...
    public int getNumberOfPeopleOn(@PathVariable("date") Date date,@RequestParam("airportName")String airportName){
        ...
        int crowdOnAirport = airportService.getNumberOfPeopleOn(date, airportName);
        return crowdOnAirport;
    }
    ...
    public int calculateFlightFare(@RequestParam("flightId")Integer flightId){
        ...
        int totalFare = airportService.calculateFlightFare(flightId);
       return totalFare;
    ...
    public String bookATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        if(airportService.alreadyFilled(flightId))
        {
            return "FAILURE"; //in case of true
        }

        if(airportService.passengerBookedAlready(flightId, passengerId))
        {
            return "FAILURE"; //in case of true
        }
    ...
    public String cancelATicket(@RequestParam("flightId")Integer flightId,@RequestParam("passengerId")Integer passengerId){
        ...
        if(!airportService.flightIsValid(flightId) || !airportService.passengerBookedFlight(flightId,passengerId))
        {
            return "FAILURE"; //in case of false
        }
    ...
    public int countOfBookingsDoneByPassengerAllCombined(@PathVariable("passengerId")Integer passengerId){
        ...
        int passengerBooking = airportService.countOfBookingsDoneByPassengerAllCombined(passengerId);
    ...
    public String getAirportNameFromFlightId(@PathVariable("flightId")Integer flightId){
        ...
        if(!airportService.flightIsValid(flightId))
        {
            return null;
        }
        String flightCity = airportService.getAirportNameFromFlightId(flightId);
        return flightCity;
    }
    ...
    public int calculateRevenueOfAFlight(@PathVariable("flightId")Integer flightId){
        ...
        int totalRevenue = airportService.calculateRevenueOfAFlight(flightId);
